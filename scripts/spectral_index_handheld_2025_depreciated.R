...
# photo_dir <- "Katz lab/texas/tx 2025 drone pics/handheld quadrat pics 2025" #not white balanced
photo_dir <- "Katz lab/texas/tx 2025 drone pics/handheld quadrat pics 2025/white_balanced" #white balanced
...
# output_subfolder <- file.path(photo_dir, "masked_white_balanced")
...
for(i in 1:length(photo_list)){
  ...
  # #code for not white balanced sub folder
  ...
  #code for white balanced sub folder
  save_file_name <- file.path(output_subfolder, photo_list[i])
  raster::writeRaster(photo_i, save_file_name, overwrite = TRUE)
  print(i)
}
...
#test white balanced folder imgs
# test3 <- rast("C:/Users/hmz25/Box/Katz lab/texas/tx 2025 drone pics/handheld quadrat pics 2025/white_balanced/masked_white_balanced/cath_t10.tif")
# plot(test3)
...
# fit <- lm(quadrat_cones_rgb$mean_cones_per_fol  ~ quadrat_cones_rgb$photo_i_index_rg_thresh_sum)
# summary(fit)
# r_sq <- summary(fit)$r.squared
...
#cell tree 8 -- 
cell_t8 = stack("C:/Users/hmz25/Box/Katz lab/texas/tx 2025 drone pics/handheld quadrat pics 2025/masked_handheld_quadrat_pics/cath_t8.tif")
plotRGB(cell_t8)
